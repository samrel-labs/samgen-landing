(function() {
    ...
    const teamData = {
        fa: [
            { name: 'سعید علیدوست', role: 'بنیان‌گذار و مدیرعامل', bio: 'بیش از ۱۵ سال تجربه در مدیریت استراتژیک، سرمایه‌گذاری و توسعه کسب‌وکار.', initial: 'س' },
            { name: 'سبحان علیدوست', role: 'عضو هیئت مدیره', bio: 'کارشناس ارشد مدیریت مالی با سابقه درخشان در بانک‌داری و سرمایه‌گذاری.', initial: 'س' },
            { name: 'فاطمه علیدوست', role: 'عضو هیئت مدیره', bio: 'متخصص حقوق تجارت و قراردادهای بین‌المللی با ۱۲ سال تجربه.', initial: 'ف' },
            { name: 'سام علیدوست', role: 'مدیر بازرگانی', bio: 'کارشناس ارشد بازرگانی بین‌المللی و توسعه بازارهای جهانی.', initial: 'س' },
            { name: 'سودا علیدوست', role: 'مدیر مالی', bio: 'متخصص مدیریت مالی، بودجه‌ریزی و کنترل هزینه‌ها در شرکت‌های بزرگ.', initial: 'س' },
            { name: 'نازنین سبزعلیان', role: 'مدیر فناوری اطلاعات', bio: 'متخصص معماری سیستم‌های بزرگ‌مقیاس و فناوری‌های ابری با ۱۰ سال سابقه.', initial: 'ن' }
        ],
        en: [
            { name: 'Saeed Alidoost', role: 'Founder & CEO', bio: 'Over 15 years of experience in strategic management, investment, and business development.', initial: 'S' },
            { name: 'Sobhan Alidoost', role: 'Board Member', bio: 'Expert in financial management with a distinguished background in banking and investment.', initial: 'S' },
            { name: 'Fatemeh Alidoost', role: 'Board Member', bio: 'Specialist in commercial law and international contracts with 12 years of experience.', initial: 'F' },
            { name: 'Sam Alidoost', role: 'Commercial Manager', bio: 'Expert in international trade and global market development.', initial: 'S' },
            { name: 'Sevda Alidoost', role: 'Financial Manager', bio: 'Specialist in financial management, budgeting, and cost control in large enterprises.', initial: 'S' },
            { name: 'Nazanin Sabzaliyan', role: 'IT Manager', bio: 'Expert in large-scale system architecture and cloud technologies with 10 years of experience.', initial: 'N' }
        ]
    };
